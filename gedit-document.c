...
guess_language (GeditDocument *doc)
{
	...
	/* splchk_set_lang() delcared and Defined in splchk_functions.h and splchk_functions.c */
        ...
        /* splchk_get_words() declared and Defined in splchk_functions.h and splchk_functions.c */
